...
public enum TableMatcher {
    ...
    S_ADDR_ADM_IDX_HIST(Arrays.asList("OBJECT_ID", "PAR_OBJECT_ID"), "2", Arrays.asList("NULL, 1, S_ADDR_ADM_REL_HIST")),
    S_ADDR_MUN_IDX(Arrays.asList("OBJECT_ID", "PAR_OBJECT_ID"), "2", Arrays.asList("1, 1, S_ADDR_MUN_REL")),
    S_ADDR_MUN_IDX_HIST(Arrays.asList("OBJECT_ID", "PAR_OBJECT_ID"), "2", Arrays.asList("NULL, 1, S_ADDR_MUN_REL_HIST"));
